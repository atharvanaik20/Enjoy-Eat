...
class ViewCard extends react.Component {
    ...
    getAmount = () => {
        ...
        this.props.carddetails.map(({ rate, qty }) => {
            ...
            if (qty > 10) {
                ...
                alert("Please, add quantity less than 10..! Your added Quantity= " + qty);
            }
        })
        return amount;
    }
    //customer_id ,"branchId":1,menuDetails:{ menuId,quantity}
    //http://localhost:8081/customer/saveOrder
    ...
    submitData = (e) => {
        ...
        axios.post('http://localhost:8081/customer/saveOrder', request)
            .then(response => {
        ...
        return (
            <div>
                <table className="table table-striped">
                    ...
                    <tbody>
                        {this.props.carddetails.map(({ menuName, rate, menuId, qty }, index) => {
